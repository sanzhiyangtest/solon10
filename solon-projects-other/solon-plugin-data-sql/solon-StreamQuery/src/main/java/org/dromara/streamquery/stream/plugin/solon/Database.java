...
import com.baomidou.mybatisplus.solon.toolkit.SimpleQuery;
...
public class Database {
   ...
   * @param mapper a {@link Function} object
   ...
   * notActive.
   *
   * @param condition a {@link Boolean} object
   * @param wrapper a T object
   * @param <T> a T class
   * @return a T object
   */
   ...
   * @param condition a {@link SFunction} object
   * @param <T> a T class
   * @param <E> a E class
   ...
   * @param <T> a T class
   * @param <K> a K class
   * @return a {@link LambdaQueryWrapper} object
   */
   ...
   * select.
   *
   * @param wrapper a {@link LambdaQueryWrapper} object
   * @param columns a {@link SFunction} object
   * @param <T> a T class
   * @return a {@link LambdaQueryWrapper} object
